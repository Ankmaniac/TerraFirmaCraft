...
def make_book(rm: ResourceManager, i18n: I18n, local_instance: bool = False, reverse_translate: bool = False):
    ...
    book.category('mechanics', 'Advanced Mechanics', 'Advanced sections of the tech tree, from the first pickaxe, all the way to colored steel.$(br2)$(br)$(bold)Note:$() you can search entries simply by starting to type anywhere!', 'tfc:metal/axe/red_steel', entries=(
        ...
        entry('storage', 'Storage', 'tfc:wood/chest/oak', pages=(
            text('Your own inventory only holds so much, so the world provides many ways to keep items safe and organized. $(thing)Chests$() and $(thing)Crates$() store the most, while $(thing)Tool Racks$(), $(thing)Shelves$(), and $(thing)Baskets$() each serve a purpose.$(br2)Keep in mind that an item\'s $(l:getting_started/size_and_weight)Size ⇲$() limits which containers it will fit inside.'),
